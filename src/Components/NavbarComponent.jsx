...
const NavbarComponent = (props) => {
  ...
  return (
    <>
    <nav className='flex justify-between md:px-10  lg:px-20 lg:-mt-2  md:-mt-4 text-[14px] ease-in-out duration-300 font-ubuntu '>
    ...
    {/* for mobile navlist */}
    {active ? <div className={`z-20 items-center absolute backdrop-blur-sm  bg-[#189a468b] w-full h-[90vh] text-center text-xl  `}>
    ...
    <NavLink className={`border rounded-xl py-2 border-[#029837] p-2 ${props.active == 'contact' ? " bg-[#029837] text-white " : "text-[#029837]  bg-[#f7fff6]"}`} to={"/contact"}>Contact Us</NavLink>
    </div> : ""}
    </>
  )
}
