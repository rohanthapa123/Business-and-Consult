  ...
  return (
    <div className='  absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] w-full'>
      <div className='text-center space-y-6 px-10 py-4 flex flex-col items-center '>
        ...
        <p>You have successfully registered for the webinar “How to understand your spouse better towards a blissful<br/> union” by Jo-Jean Imoh-Ita</p>
        <p className='font-bold '>You will receive and email within 24 hours with the link to access the webinar.</p>
        <p className='pb-3' >The webinar is hosted on the ZOOM platform. Looking forward to having you</p>
        <p>Thank You!</p>
